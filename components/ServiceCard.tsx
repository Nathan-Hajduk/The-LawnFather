...
export function ServiceCard({ service }: ServiceCardProps) {
  return (
    <Link href={`/quote?service=${service.key}`} className="block h-full">
      <article className="glass-panel h-full overflow-hidden p-6 transition duration-300 hover:-translate-y-1 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400">
